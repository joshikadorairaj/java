...
public class Registration {
    ...
    public Registration(int registration_id, String event_name, String athlete_name, java.util.Date registration_date2) {
        this.registration_id = registration_id;
        this.event_name = event_name;
        this.athlete_name = athlete_name;
        this.registration_date = (Date) registration_date2;
    }
